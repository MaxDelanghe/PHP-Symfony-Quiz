...
<form method=\"post\">
    ";
        // line 8
        if (array_key_exists("verif", $context)) {
            // line 9
            echo "    <p>Registration complete. New account was successfully registered. Please check your Email to activate the account.</p>
    ";
        }
        // line 11
        echo "    ";
...
";
    ...
    {
        return array (  142 => 41,  136 => 28,  128 => 23,  123 => 20,  115 => 17,  112 => 16,  110 => 15,  107 => 14,  101 => 12,  98 => 11,  94 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<form method=\"post\">
    {% if verif is defined %}
    <p>Registration complete. New account was successfully registered. Please check your Email to activate the account.</p>
    {% endif %}
    {% if error %}
...
{% endblock %}
", "security/login.html.twig", "/home/maxime/Documents/my_quiz (copy)/templates/security/login.html.twig");
    }
}
